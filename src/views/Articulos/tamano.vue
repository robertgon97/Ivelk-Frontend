        ...
        <form @submit.prevent="addStatus">
          <div class="row m-0 p-0 justify-content-center">
            <div class="col-md-6 mb-3">
              ...
              <el-input type="text" placeholder="Nombre" v-model="article.articulo_tamano_nombre" clearable show-word-limit maxlength="100"></el-input>
            </div>
            <div class="col-md-6 mb-3">
              <label>Diminutivo <small>(REQUERIDO)</small></label>
              <el-input type="text" placeholder="Diminutivo" v-model="article.articulo_tamano_letra" clearable show-word-limit maxlength="2"></el-input>
            </div>
          </div>
          <div class="row m-0 p-0 justify-content-center">
            <div class="col-md-6 mb-3">
              <label>Descripcion <small>(REQUERIDO)</small></label>
              <el-input type="text" placeholder="Descripcion" v-model="article.articulo_tamano_descripcion" clearable show-word-limit maxlength="300"></el-input>
            </div>
            <div class="col-md-6 mb-3">
  ...
  export default {
    ...
    methods: {
      ...
      print () {
        this.axios({
          method: `GET`,
          url: `/tamanos?pdf=true`,
          responseType: 'blob'
        })
        .then((response) => {
          fileDownload(response.data, 'Tamaños.pdf');
        })
      }
    },
    computed: {
