        ...
        <div class="Contenido p-2">
          <form class="" @submit.prevent="agregarPagoBalance(abonado)">
            ...
            <div class="col-12 mb-3">
              ...
              <el-input type="number" show-word-limit maxlength="20" min="0" placeholder="Número de transacción" v-model="abonado.balances_abonado_transaccion" prefix-icon="el-icon-document"></el-input>
            </div>
            <div class="col-12 mb-3">
