<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/tienda/usuarios' }">Usuarios y Clientes</el-breadcrumb-item>
      <el-breadcrumb-item :to="{ path: '/tienda/usuarios/crearclientes' }">Registro de Cliente</el-breadcrumb-item>
    </el-breadcrumb>
    <br />
      ...
      <form @submit.prevent="register">
        <div class="d-flex flex-wrap justify-content-init">
          ...
          <div class="col-12 col-md-4 mb-3">
            ...
            <el-input onKeyDown="if(this.value.length==9) return false;" max="999999999" min="1000000" show-word-limit placeholder="123456789" type="number" autocomplete="dni" clearable v-model="registro.personas_documento_identidad">
...
<script>
  ...
  export default {
    metaInfo: {
      titleTemplate: '%s | Registro de Cliente'
    },
    data () {
      return {
        registro: {
      ...
      register() {
        ...
        .then(response => {
          this.$notify({
            ...
            message: `El cliente ${response.data.data.usuario.usuario_username} se registró correctamente!`,
            type: 'success',
            duration: 0
          })
