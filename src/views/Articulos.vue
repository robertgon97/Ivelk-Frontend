<template>
  <div class="container">
    ...
    <div v-else-if="getAllArticulos && getAllArticulos.length" class="d-flex overflow-auto py-5 bg-light">
      <div v-for="(articulo) in getAllArticulos" :key="articulo.articulos_id" class="col-3">
