          ...
          <form @submit.prevent="register(getIDProveedores)">
            <div class="row m-0 p-0 justify-content-between">
              ...
              <div class="col-md-4 mb-3">
                ...
                <el-input placeholder="123456789" type="number" autocomplete="dni" clearable onKeyDown="if(this.value.length==9) return false;" max="999999999" min="1000000" maxlength="9" v-model="getIDProveedores.proveedor_rif"></el-input>
              </div>
            </div>
            <div class="row m-0 p-0 justify-content-between">
